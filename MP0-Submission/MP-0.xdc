...
# JA Pmod - Bank 13
# ----------------------------------------------------------------------------
#set_property PULLTYPE PULLDOWN [get_ports {CTRL_Data}];
#set_property PULLTYPE PULLDOWN [get_ports {CTRL_Latch}];
#set_property PULLTYPE PULLDOWN [get_ports {CTRL_Timing}];



set_property PACKAGE_PIN Y11  [get_ports {JA_tri_io[0]}];  # "JA1"
#set_property PACKAGE_PIN AA8  [get_ports {CTRL_Latch}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {JA_tri_io[1]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {JA_tri_io[2]}];  # "JA3"
...
connect_debug_port u_ila_0/clk [get_nets [list zynq_design_1_i/processing_system7_0/inst/FCLK_CLK0]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
set_property port_width 1 [get_debug_ports u_ila_0/probe0]
connect_debug_port u_ila_0/probe0 [get_nets [list {zynq_design_1_i/axi_vdma_0_M_AXI_MM2S_ARBURST[0]}]]
